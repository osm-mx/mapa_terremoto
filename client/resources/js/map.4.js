...
function addEscuelasLayer(){
    $.get("/resources/data/escuelas/reapertura.geojson", function(geojson){
        escuelasLayer.addData(JSON.parse(geojson));
    });
}


function addEvaluacionEstructural(){
    $.get("https://cedn.carto.com/api/v2/sql?q=SELECT * FROM evaluacion_estructural_update&format=GeoJSON", function(data){
...
function addBuildingsData(){
    $.get("/resources/data/gob.mx/edificios_crowd.geojson", function(geojson){
    ...
    // verificado 19s
    $.get("/resources/data/horizontal/edificios.geojson", function(geojson){
        geojson = JSON.parse(geojson);
...
function addOfrezcoNecesitoData(){
    ...
    $.get("/resources/data/ofrezco_necesito/ofrezco.geojson", function(ofrezco){
        ofrezcoLayer.addData(JSON.parse(ofrezco));
    });


    $.get("/resources/data/ofrezco_necesito/necesito.geojson", function(necesito){
        necesitoLayer.addData(JSON.parse(necesito));
    });
}
...
function addAlberguesData(){
    ...
    $.get("/resources/data/gob.mx/albergues_crowd.geojson", function(geojson){
        alberguesLayer.addData(JSON.parse(geojson));
    });
...
function addAcopioData(){
    ...
    $.get("/resources/data/gob.mx/acopio_crowd.geojson", function(geojson){
        acopioLayer.addData(JSON.parse(geojson));
    });
